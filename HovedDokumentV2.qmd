...
# Bygg "df_7_csB": X-gjennomsnitt + folketallsvekst + syssvekst
df_7_csB <- df_6_csB %>%  # har: knr24, start_år, end_år, X-mean, folketallsvekst
  inner_join(df_7_syss %>% select(knr24, start_år, end_år, syssvekst_pct),
             by = c("knr24","start_år","end_år")) %>%
  filter(is.finite(syssvekst_pct), is.finite(folketallsvekst)) %>%
